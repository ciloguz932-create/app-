            ...
            >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <p className={cn(
                        ...
                        p.language === "ar" ? "font-arabic text-lg" : ""
                      )} dir={p.language === "ar" ? "rtl" : "ltr"}>
                        {p.title}
                      </p>
                      <span className={cn(
                        "inline-block text-xs font-medium px-2 py-0.5 rounded-full border mt-1 capitalize",
                        difficultyColors[p.difficulty] ?? "text-muted bg-cream-dark border-cream-darker"
                      )}>
                        {p.difficulty}
                      </span>
                    </div>
              ...
              {passages.length === 0 && (
                <div className="text-center py-12 text-muted text-sm">
                  No passages available for this language.
                </div>
              )}
            </motion.div>
          </AnimatePresence>
